...
pro modis_l1b_pwv_retrieval
  ...
  result_name='O:/coarse_data/chapter_5/MYD021KM.A2013278.0525.006.2013278174924_PWV_GEO.tiff'  
  ...
  PWV=0.326*PWV_band17+0.369*PWV_band18+0.566*PWV_band19
  modis_target_data=PWV*(cloud_result eq 0)
